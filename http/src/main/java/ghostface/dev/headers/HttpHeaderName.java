...
public abstract class HttpHeaderName<T> {
    ...
    public abstract @NotNull String serialize(@NotNull HttpHeader<T> header, @NotNull MediaType.Parameter @NotNull ... parameters);
    ...
    private static final class Provider {
        ...
        private static final class ContentJson extends HttpHeaderName<@NotNull MediaType<@NotNull JsonElement>> {
            ...
            public @NotNull String serialize(
                    ...
                    @NotNull MediaType.Parameter @NotNull ... parameters
            ) {
                @NotNull StringJoiner joiner = new StringJoiner("; ");
                joiner.add(name() + ": " + "application/json");
                for (@NotNull MediaType.Parameter parameter : parameters) {
        ...
        private static final class Connection extends HttpHeaderName<@NotNull Boolean> {
            ...
            @Override
            public @NotNull String serialize(@NotNull HttpHeader<@NotNull Boolean> header, @NotNull MediaType.Parameter @NotNull ... parameters) {
